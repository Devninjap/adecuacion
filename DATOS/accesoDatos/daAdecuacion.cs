    ...
    public class daAdecuacion : iOperaciones<adecuacion>
    {
        ...
        public object consultaReporte(int idAdecuacion)
        {
            try
            {
                ...
                {
                    return (from estudiante in ctx.estudiante
                            join adecuacion in ctx.adecuacion on estudiante.idEstudiante equals adecuacion.idEstudiante
                            join detalles in ctx.detalleAdecuacion on adecuacion.idAdecuacion equals detalles.idAdecuacion
                            join equivalencias in ctx.equivalenciaAsignatura on detalles.idEquivalencia equals equivalencias.idEquivalencia                   
                            where adecuacion.idAdecuacion == idAdecuacion
                            select new
                            {
                                estudiante.apellidosEstudiante,
